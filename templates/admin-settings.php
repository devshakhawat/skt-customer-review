<div class="wrap">
	...
	<h1><?php esc_html_e( 'Settings', 'review-booster' ); ?></h1>
	<h2><?php esc_html_e( 'Settings for Customer Reviews', 'review-booster' ); ?></h2>
	<p><?php esc_html_e( 'Here you can view and manage video reviews.', 'review-booster' ); ?></p>
	...
	<form action="" id="skt_plugin_settings" method="post">
		<table class="form-table">	
			<tr>
				<th scope="row" class="titledesc">
					<label for="enable_video_btn">
						<?php esc_html_e( 'Video Record Button:', 'review-booster' ); ?>									
					</label>
				</th>
				<td class="skt_video_btn">
					...
					<span><?php esc_html_e( 'Show or Hide Video Record Button to all Products Page.', 'review-booster' ); ?></span>
				</td>
			</tr>
			...
			<tr>
				<th scope="row" class="titledesc">
					<label for="show_file_uploader">
						<?php esc_html_e( 'File Uploader:', 'review-booster' ); ?>									
					</label>
				</th>
				<td class="skt_video_btn">
					...
					<span><?php esc_html_e( 'Show or Hide File Uploader Button to all Products Page.', 'review-booster' ); ?></span>
				</td>
			</tr>
			...
			<!-- <tr>
				<th scope="row" class="titledesc">
					<label for="required_video">
						<?php // esc_html_e( 'Required Video Recorder:', 'review-booster' ); ?>									
					</label>
				</th>
				<td class="forminp forminp-select">
					...
					<span><?php // esc_html_e( 'Required or Optional to make this field', 'review-booster' ); ?></span>
				</td>
			</tr> -->
			...
			<!-- <tr>
				<th scope="row" class="titledesc">
					<label for="required_file_uploader">
						<?php // esc_html_e( 'Required File Uploader:', 'review-booster' ); ?>									
					</label>
				</th>
				<td class="forminp forminp-select">
					...
					<span><?php // esc_html_e( 'Required or Optional File Uploader', 'review-booster' ); ?></span>
				</td>
			</tr> -->
			...
			<!-- <tr>
				<th scope="row" class="titledesc">
					<label for="required_text_comment">
						<?php // esc_html_e( 'Required Text Comment:', 'review-booster' ); ?>									
					</label>
				</th>
				<td class="forminp forminp-select">
					...
					<span><?php // esc_html_e( 'Make Required or Optional File Uploader', 'review-booster' ); ?></span>
				</td>
			</tr> -->

			<tr class="disabled">
				<th scope="row" class="titledesc">
					<label for="video_duration"><?php esc_html_e( 'Video Duration:', 'review-booster' ); ?></label>
				</th>
				<td class="forminp forminp-number">
					...
					<span><?php esc_html_e( 'Increase or Decrease Video Duration in ( Minutes )', 'review-booster' ); ?></span>   
			...
			<tr>
				<th scope="row" class="titledesc">
					<label for="review_btn_color"><?php esc_html_e( 'Button Color:', 'review-booster' ); ?></label>
				</th>
				<td class="forminp forminp-select">
					...
					<span><?php esc_html_e( 'Adjust Video Record Button Color', 'review-booster' ); ?></span>
				</td>
			</tr>

			<tr>
				<th scope="row" class="titledesc">
					<label for="review_btn_txt_color"><?php esc_html_e( 'Button Texts Color:', 'review-booster' ); ?></label>
				</th>
				<td class="forminp forminp-select">
					...
					<span><?php esc_html_e( 'Adjust Video Record Button Texts Color', 'review-booster' ); ?></span>
				</td>
			</tr>

			<tr>
				<th scope="row" class="titledesc">
					<label for="review_btn_text"><?php esc_html_e( 'Button Text:', 'review-booster' ); ?></label>
				</th>
				<td class="forminp forminp-select">
					<input type="text" name="review_btn_text" id="review_btn_text" value="<?php esc_attr_e( 'Record Video', 'review-booster' ); ?>" />
					<?php echo wp_kses_post( wc_help_tip( 'Change Button Texts', false ) ); ?>
					<span><?php esc_html_e( 'Change Button Texts', 'review-booster' ); ?></span>
				</td>
			</tr>
